...
class ShiroDbRealm {
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def results = ShiroUser.executeQuery("select distinct p from dude.ShiroUser as user join user.roles as role join role.permissions as p where user.username = '$principal'")
